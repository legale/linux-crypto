...
#define KUZ_SIMD_VERSION "20260821.5"
...
#if defined(CONFIG_ARM64)
  pr_info("kuznyechik_simd: bench paths: 1way=ttable 4way=ttable 8way=tableless 16way=tableless dec8/16=ttable ctr8/16=fused omac8=8way\n");
#else
